...
def export_to_csv(employee_id, employee_name, employee_todo_list):
    """ Method exports data to CSV file """
...
if __name__ == "__main__":
    ...
    export_to_csv(employee_id, employee_id_data['name'], employee_todo_list)
